const classes = {
  root: {
    ...
    triangle:
      'border-solid h-12 border-t-transparent border-b-transparent border-t-[24px] border-r-[0px] border-b-[24px] border-l-[5px]',
  },
  rounded: {
    lg: { iconContainer: 'rounded-tl-lg rounded-bl-lg', button: 'rounded-lg' },
    full: {
      iconContainer: 'rounded-tl-full rounded-bl-full',
      button: 'rounded-full',
    },
  },
  cursor: {
  ...
  colors: {
    ...
    neutral: {
      ...
      shape: {
        ...
        loading: 'text-darklightgray-500',
      },
    },
    error: {
      button: {
